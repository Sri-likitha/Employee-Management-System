...
### 🧾 Tables Used
	...
	•	🗓 Leave Table – Records employee leave details.
	•	💰 Payroll Table – Handles salary and deductions.
...
### Some example queries used in the project:
	...
	5.	💸 Compute total salary expenditure.
	6.	📈 Find departments with highest total salary allocation.
	7.	🗓 Determine employees with the most leaves.
